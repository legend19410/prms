...
//		http.addFilterBefore(new CustomAuthorizationFilter(), UsernamePasswordAuthenticationFilter.class);
	...
	public CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.setAllowedOrigins(Arrays.asList("/**", "https://jcf-resource-manager.herokuapp.com", "http://localhost:3001", "http://localhost:3002", "http://localhost:3000", "https://nifty-booth-09e6a0.netlify.app"));
